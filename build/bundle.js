...
/***/ function(module, exports) {
	...
	var Coordinates = function Coordinates(xAxis, yAxis, state) {
	  return {
	    "x": xAxis,
	    "y": yAxis,
	    "state": state
	...
	var buildArray = function buildArray(x, y, state) {
	  for (var i = 0; i <= x; i++) {
	    twinkles[i] = [];
	    for (var j = 0; j <= y; j++) {
	...
	var changeState = function changeState(instruction) {
	...
	var countTwinkles = function countTwinkles(xLength, yLength) {
	  var lightCount = 0;
	...
	var mainFunc = function mainFunc(xLength, yLength, initialState, input) {
	  parseInput(input);
